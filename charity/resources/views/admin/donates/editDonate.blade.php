...
@section('content')
    ...
    <section class="content">
        <div class="box box-warning">
            ...
            {!! Form::model($donate, ['method' => 'PATCH', 'action' => ['App\Http\Controllers\DonateController@update', $donate->id], 'id' => 'form']) !!}
            <div class="form-group col-md-6">
                {!! Form::label('user_id', 'Donate By:') !!}
            <small class="error">{{ $errors->first('user_id') }}</small>
                {!! Form::select('user_id', ['' => 'Selcet the Donator'] + $donators, null, ['class' => 'form-control']) !!}
            </div>
            <div class="form-group col-md-6">
            ...
            <small class="error">{{ $errors->first('currency') }}</small>
                {!! Form::select('currency', ['AF' => 'AF', 'USD' => 'USD', 'ERO' => 'ERO'], null, ['class' => 'form-control', 'required']) !!}
            </div>
            ...
            <div class="form-group col-md-6">
                {!! Form::label('donation_box_id', 'Donation Box:') !!}
