...
@section('content')
    <section class="content-header">
        <h1>Edit Monthly Sponsor</h1>
    </section>
    <section class="content">
        <div class="box box-warning">
        <div class="box-header">
        </div>
        {!! Form::model($monthly_sponsor,['method' => 'PATCH', 'action' => ['App\Http\Controllers\MonthlySponsorsController@update', $monthly_sponsor->id], 'id' =>'form']) !!}
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::date('duration', null, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group col-md-12">
            {!! Form::label('description', 'Description:') !!}
            <small class="error">{{ $errors->first('description') }}</small>
            {!! Form::textarea('description', null, ['class' => 'form-control', 'data-parsley-length' => '[1,500]']) !!}
        </div>
